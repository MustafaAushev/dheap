...
//{
//	ASSERT_NO_THROW(D_heap *a = new D_heap(3, 10));
//}
//
//TEST(D_heap, throws_when_arity_is_negative)
//{
//	ASSERT_ANY_THROW(D_heap *heap = new D_heap(-3, 10));
//}
//
//TEST(D_heap, can_copy_heap)
//{
//	D_heap *a = new D_heap(3, 10);
//	ASSERT_NO_THROW(D_heap *b = new D_heap(*a));
//}
//
//TEST(D_heap, GetParent_works_properly)
//{
//	D_heap *a = new D_heap(3, 11);
//	int c = a->GetParent(6);
//	EXPECT_EQ(c, 1);
//}
//
...
//{
//	int c;
//	D_heap *a = new D_heap(3, 0);
//	a->Push(5);
//	a->Push(8);
//	D_heap *b = new D_heap(3, 0);
//	b->Push(8);
//	b->Push(5);
//
//	b->Swap(0, 1);
...
//}
//
//TEST(D_heap, throws_when_SiftUp_ninexisting_element)
//{
//	D_heap *a = new D_heap (3, 13);
